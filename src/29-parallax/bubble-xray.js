...
export default function bubble-xray(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="525px" height="525px" viewBox="0 0 525 525" style={{enableBackground: 'new 0 0 525 525'}} xml:space="preserve" {...props}>
      <g id="Layer_2_1_" style={{display: 'none'}}>
        <rect x={-19} y={-33} style={{display: 'inline', fill: '#222222', stroke: '#000000', strokeWidth: 2, strokeMiterlimit: 10}} width={570} height={584} />
      </g>
      <g id="Layer_1">
        ...
        <radialgradient id="SVGID_1_" cx="262.2373" cy="261.8506" r="259.8681" gradientUnits="userSpaceOnUse">
          <stop offset={0} style={{stopColor: '#85FF00', stopOpacity: '0.1'}} />
          <stop offset="0.5347" style={{stopColor: '#86FF00', stopOpacity: '0.1'}} />
          <stop offset="0.9994" style={{stopColor: '#86FF00', stopOpacity: '0.8'}} />
        </radialgradient>
