...
User.getInitialProps = async function(context) {
    ...
    const permission = {
        details: details_user_permission(current_user, { owner: id }),
        update: update_user_permission(current_user, { owner: id }),
        delete: delete_user_permission(current_user, { owner: id }),
    }
